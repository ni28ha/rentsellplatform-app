...
export default function CreateListing() {
  ...
  async function onSubmit(e) {
    e.preventDefault();
    setLoading(true);
    // adding + to ensure that discount  price and regular price is a number 
    ...
    const imgUrls = await Promise.all(
     ...
     // creating the copy of form data as we don't want to change the form data
    const formDataCopy = {
      ...formData,
      imgUrls,
      geolocation,
    ...
    const docRef = await addDoc(collection(db, "listings"), formDataCopy); // adding to database
    setLoading(false);
