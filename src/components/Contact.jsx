      ...
      {landlord !== null && (
        <div className="flex flex-col w-full mt-3">
            ...
            <div  className="mt-3 mb-6">
                <textarea name="message" id="message" value={message} rows="2"
                 onChange={onChange}
            ...
            <a href={`mailto:${landlord.email}?Subject${listing.name}&body=${message}`}>
                <button className="px-7 py-3 bg-blue-600 text-white rounded text-sm 
                ...
                focus:shadow-lg active:bg-blue-800 active:shadow-lg transition duration-150
                 ease-in-out w-full text-center mb-6">Send Message</button>
            </a>
        </div>
      )}  
    </>
